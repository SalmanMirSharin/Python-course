...
driver1 = Driver('driver1','driver@gmail.com','driver1',random.randint(0,30),1253)
driver1.take_driving_test()
driver1.register_a_vehicle('car',5462,10)
driver2 = Driver('driver2','driver@gmail.com','driver2',random.randint(0,30),1253)
driver2.take_driving_test()
driver2.register_a_vehicle('car',5462,10)
driver3 = Driver('driver3','driver@gmail.com','driver3',random.randint(0,30),1253)
driver3.take_driving_test()
driver3.register_a_vehicle('car',5462,10)
driver4 = Driver('driver4','driver@gmail.com','driver4',random.randint(0,30),1253)
driver4.take_driving_test()
driver4.register_a_vehicle('car',5462,10)
